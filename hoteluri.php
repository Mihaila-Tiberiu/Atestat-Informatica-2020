...
<head>
<meta charset="UTF-8">
<title>Hoteluri in Oltenita </title>
...
<header>
	<a href="index.php"><input type="button" value="Inapoi Acasa"></a> - Hoteluri 
	<?php 
		...
		<tbody>
			...
			?>
				<tr>
					<td>
						<form action="" method="post">
							<input type="hidden" id="ins" name="ins" value='<?php echo $row['idHotel']; ?>'>
					...
					<td style="width:10%;"><img class="tabelprezentare" src="imagini/hoteluri/<?php echo $row['poza'];?>"></td>
					<td><?php $sql2="SELECT * FROM `recenziihoteluri` WHERE idInstitutie='".$row['idHotel']."';";  //
