...
<head>
<meta charset="UTF-8">
<title>Magazine in Oltenita </title>
...
<header>
	<a href="index.php"><input type="button" value="Inapoi Acasa"></a> - Magazine 
	<?php 
		...
		<tbody>
			...
			?>
				<tr>
					<td>
						<form action="" method="post">
							<input type="hidden" id="ins" name="ins" value='<?php echo $row['idMagazin']; ?>'>
							<input type="submit" value="Vezi Recenziile!">
						</form>
						<?php
						if(isset($_POST['ins']))
						{
							$_SESSION['ins2']=$_POST['ins'];
					...
					<td style="width:10%;"><img class="tabelprezentare" src="imagini/magazine/<?php echo $row['poza'];?>"></td>
					<td><?php $sql2="SELECT * FROM `recenziimagazine` WHERE idInstitutie='".$row['idMagazin']."';";  //
