...
<head>
<meta charset="UTF-8">
<title>Monumente in Oltenita </title>
...
<header>
	<a href="index.php"><input type="button" value="Inapoi Acasa"></a> - Monumente 
	<?php 
		...
		<tbody>
			...
			?>
				<tr>
					<td>
						<form action="" method="post">
							<input type="hidden" id="ins" name="ins" value='<?php echo $row['idMonument']; ?>'>
							<input type="submit" value="Vezi Recenziile!">
						</form>
						<?php
						if(isset($_POST['ins']))
						{
							$_SESSION['ins5']=$_POST['ins'];
					...
					<td style="width:10%;"><img class="tabelprezentare" src="imagini/monumente/<?php echo $row['poza'];?>"></td>
					<td><?php $sql2="SELECT * FROM `recenziimonumente` WHERE idInstitutie='".$row['idMonument']."';";  //
